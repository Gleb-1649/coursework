...
/**
 * Класс XmlUtils обеспечивает загрузку и сохранение коллекции Person в XML-файл.
 */
        ...
        try {
            ...
            for (int i = 0; i < personNodes.getLength(); i++) {
                ...
                if (node.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    ZonedDateTime creationDate = ZonedDateTime.now(); // creationDate не хранится в файле
                    ...
                    try {
                        ...
                        if (!eyeColorStr.isBlank()) {
                            eyeColor = Color.valueOf(eyeColorStr.toUpperCase());
                        }
                    } catch (Exception ignored) {}
                    String natStr = elem.getElementsByTagName("nationality").item(0).getTextContent();
                    Country nationality = Country.valueOf(natStr.toUpperCase());
